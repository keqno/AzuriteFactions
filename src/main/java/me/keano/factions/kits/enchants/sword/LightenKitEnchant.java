...
public class LightenKitEnchant extends KitEnchant {

    public LightenKitEnchant() {
        super(
                "Lighten",
                "Has a chance to heal 4 hearts and deal 2 hearts.",
                5
        );
    }
    ...
    public void onDamage(EntityDamageByEntityEvent e) {
        ...
        for (String string : item.getItemMeta().getLore()) {
            ...
            EnchantUtils.addHealth(damager, 4.0);
            EnchantUtils.takeHealth(damaged, 2.0);
            damager.getWorld().strikeLightningEffect(damaged.getLocation());
