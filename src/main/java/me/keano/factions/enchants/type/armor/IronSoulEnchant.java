...
public class IronSoulEnchant extends Enchant {

    public IronSoulEnchant() {
        super(
                "IronSoul",
                2,
                "Armor",
                "Gain permanent resistance dependent on the level."
        );
    }
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            for (String string : newArmor.getItemMeta().getLore()) {
                                ...
                                player.addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, Integer.MAX_VALUE, getLevel(string) - 1));
                            }
                        }
