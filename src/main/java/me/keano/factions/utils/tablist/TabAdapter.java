...
import me.keano.factions.utils.tablist.entry.TabEntry;
...
public abstract class TabAdapter {
    ...
    /**
     * Set up the profiles of the tab adapter
     */
     ...
     */
    public abstract void sendEntryData(Player player, int axis, int ping, String text);
